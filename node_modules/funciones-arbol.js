...
function inicializarArbol(h,w,source,hst,settings){
    ...
    try{weightLinks = settings.treeColors.weightLinks;}catch(e){}
    ...
    function update(source) {
        ...
        else if (initialMode=="pathbestnode") expandBestNodes(source);
