...
function createSourceRowTree (sourceRow,metadataSourceTable) {
    ...
    var numCategories = 0,itemValue=null;itemTarget=null,itemAvance=null;
...
function inicializarArbol(h,w,source,hst,settings){
    ...
    var levelSize = 180;
    try{levelSize = settings.treeOptions.levelSize}catch(e){}
    ...
    var margin = {top: 0, right: 100, bottom: 0, left: 90},
    ...
    function updateGraph(nodes,source,hst,selectionMngr){
        ...
        link.enter().insert("path", "g")
            ...
            .attr("style",function(d){
                ...
                if (d.selected) strokeDasharray=5;
